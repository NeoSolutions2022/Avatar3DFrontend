...
class PoseApiTests(unittest.TestCase):
    ...
    def test_health_and_complete_pose_lifecycle(self) -> None:
        ...
        self.assertEqual(health.json()["app_version"], "2026.08.22-clean-retarget.1")
        self.assertEqual(
    ...
    def test_mvp_page_is_available(self) -> None:
        ...
        self.assertIn("v2026.08.22-clean-retarget.1", response.text)
    ...
    def test_widget_page_and_public_config_are_available(self) -> None:
        ...
        self.assertEqual(
            config.json()["app_version"], "2026.08.22-clean-retarget.1"
        )
